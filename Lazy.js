...
;(function($,window,document){
	...
	$.fn.giLazy = function(data){
		...
		this.each(function(){
			...
			if(!timg.src){
				...
				$(this).attr('data-disp',timg.disp).css({"display":"none"}).after('<div class="gi-darken" style="'+timg.css+'"><div class="gilazy-loader gi-spin"></div></div>');
			} else {
	...
	function giStageClose(){
		...
		$('.gazeimg-container').fadeOut(300,function(){
			$(this).remove();
